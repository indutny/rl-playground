...
export default class Train {
  ...
  async step({ model, envs, state, history, rewards }) {
  ...
  async runEpoch(epochNum) {
    ...
    const { finalRewards, history } = await this.stepLoop(this.model, envs);
